...
int main(int argc, char* argv[])
{
	...
	correcter.Correction(correcter.srcLabIm, correcter.refLabIm, sceneFn, folder, srcFn);

	imwrite(folder + "/" + srcFn + "_last_sim_IN.png", correcter.init_sim_corr);
	imwrite(folder + "/" + srcFn + "_last_weight_IN.png", correcter.init_weight_corr);
